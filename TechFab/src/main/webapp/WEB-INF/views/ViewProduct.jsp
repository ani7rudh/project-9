        				...
        				<div class="col-md-6 col-sm-12 col-xs-12 product-viewer clearfix">
        					...
        					<div id="product-image-carousel-container">
        						<ul id="product-carousel" class="celastislide-list">
	        						...
	        						<li><a data-rel='prettyPhoto' href="resources/images/{{productdata.productId}}-1.jpg"><img src="resources/images/{{productdata.productId}}-1.jpg" alt="Phone photo 3"></a></li>
	        						<li><a data-rel='prettyPhoto' href="resources/images/{{productdata.productId}}-2.jpg"><img src="resources/images/{{productdata.productId}}-2.jpg" alt="Phone photo 4"></a></li>
        					...
        					<div id="product-image-container">
        						<figure><img src="resources/images/{{productdata.productId}}-3.jpg" alt="Product Big image" id="product-image" data-big="resources/images/{{productdata.productId}}.jpg">
